...
export default function Offer(props){
    ...
    const offerData =  useSelector (state => 
        offerDataSelector(state, {id: id, type: "offers"})
      )

return(
    
        
    <Grid container   alignItems="center" justify="space-between" className={`${className} `}>
    ...
    <Grid item container xs={9} direction="column" alignItems="stretch" justify="center">
